        ...
        .then(users => {
            users.forEach(user => {
                ...
                <tr>
                    ...
                    <td>${user.roles.map(e => " " + e.role.substr(5))}</td>
                    <td>
                        <button style="font-size: 20px;" type="button" data-userid="${user.userId}" data-action="edit" class="btn btn-primary"
                            className data-toggle="modal" data-target="#editModal">Edit</button>
                    </td>
                    <td>
                        <button style="font-size: 20px;" type="button" data-userid="${user.userId}" data-action="delete" class="btn btn-danger"
